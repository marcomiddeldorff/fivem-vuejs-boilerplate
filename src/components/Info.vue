...
<template>
    <div class="absolute top-[25%] left-24 translate-y-[-25%] text-white space-y-4">
        <div class="flex items-center gap-3">
            <div
                class="h-8 w-8 flex items-center text-xs font-gilroyBold justify-center border-2 border-primary text-primary rounded">
                ESC
            </div>
            Inventar schließen
        </div>
        <div class="flex items-center gap-3">
            <div class="h-8 w-8 flex items-center justify-center border-2 border-primary text-primary rounded">
                <i class="fal fa-hand-pointer"></i>
            </div> Gegenstand Verschieben
        </div>
        <div class="flex items-center gap-3">
            <div class="h-8 w-8 flex items-center justify-center border-2 border-primary primary rounded">
                <svg fill="#2FB7F7" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="17px" height="17px" viewBox="0 0 356.572 356.572"
                    xml:space="preserve">
                    <g>
