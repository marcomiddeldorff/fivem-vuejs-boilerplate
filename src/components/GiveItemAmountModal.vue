   ...
   <transition name="zoomInOut">
      <div
         ...
         <p class="mt-2 text-white/60">
            Bitte gebe die Anzahl des Gegenstandes ein, die du dem unten festgelegten Bürger geben möchtest.
         </p>
         <ul class="grid grid-cols-2 gap-4 my-2">
            <li class="text-white/60">
               <b class="text-white">Gegenstand: </b> {{ item ? item.label : '' }}
            </li>
            <li class="text-white/60">
               <b class="text-white">Bürger: </b> {{ playerId }}
            </li>
         </ul>
